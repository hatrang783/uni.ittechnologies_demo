...
class FavoritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favorite" do
    assert_difference("Favorite.count") do
      post favorites_url, params: { favorite: { customer_id: @favorite.customer_id, product_id: @favorite.product_id } }
    end
  ...
  test "should update favorite" do
    patch favorite_url(@favorite), params: { favorite: { customer_id: @favorite.customer_id, product_id: @favorite.product_id } }
